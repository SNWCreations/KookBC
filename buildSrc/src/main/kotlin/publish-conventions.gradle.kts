...
indra {
    ...
    configurePublications {
        pom {
            url = "https://github.com/SNWCreations/KookBC"
            description = "The Kook Bot Client & JKook API standard implementation for Java."
            developers {
                developer {
                    id = "SNWCreations"
                    name = "SNWCreations"
...
tasks.sonatypeCentralUpload {
    ...
    val privateKeyPwd =
        read(System.getenv("CENTRAL_PRIVATE_KEY_PWD") ?: findProperty("CENTRAL_PRIVATE_KEY_PWD")?.toString())
