...
public class PlainTextElementSerializer implements JsonSerializer<PlainTextElement>, JsonDeserializer<PlainTextElement> {
    @Override
    ...
    @Override
    public PlainTextElement deserialize(JsonElement element, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
