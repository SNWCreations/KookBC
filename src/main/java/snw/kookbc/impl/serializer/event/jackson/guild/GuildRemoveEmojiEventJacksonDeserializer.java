...
/**
 * GuildRemoveEmojiEvent 的 Jackson 反序列化器
 *
 * @since KookBC 0.33.0
 */
public class GuildRemoveEmojiEventJacksonDeserializer extends BaseJacksonEventDeserializer<GuildRemoveEmojiEvent> {

    public GuildRemoveEmojiEventJacksonDeserializer(KBCClient client) {
        super(client);
    }

    @Override
    protected GuildRemoveEmojiEvent deserialize(JsonNode node) {
