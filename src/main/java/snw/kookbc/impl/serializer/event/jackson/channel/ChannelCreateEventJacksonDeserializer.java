...
/**
 * ChannelCreateEvent 的 Jackson 反序列化器
 *
 * @since KookBC 0.32.2
 */
public class ChannelCreateEventJacksonDeserializer extends BaseJacksonEventDeserializer<ChannelCreateEvent> {

    public ChannelCreateEventJacksonDeserializer(KBCClient client) {
        super(client);
    }

    @Override
    protected ChannelCreateEvent deserialize(JsonNode node) {
