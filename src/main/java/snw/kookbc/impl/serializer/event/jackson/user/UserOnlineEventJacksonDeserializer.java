...
/**
 * UserOnlineEvent 的 Jackson 反序列化器
 *
 * @since KookBC 0.32.2
 */
public class UserOnlineEventJacksonDeserializer extends BaseJacksonEventDeserializer<UserOnlineEvent> {

    public UserOnlineEventJacksonDeserializer(KBCClient client) {
        super(client);
    }

    @Override
    protected UserOnlineEvent deserialize(JsonNode node) {
