...
/**
 * ChannelMessageUnpinEvent 的 Jackson 反序列化器
 *
 * @since KookBC 0.33.0
 */
public class ChannelMessageUnpinEventJacksonDeserializer extends BaseJacksonEventDeserializer<ChannelMessageUnpinEvent> {

    public ChannelMessageUnpinEventJacksonDeserializer(KBCClient client) {
        super(client);
    }

    @Override
    protected ChannelMessageUnpinEvent deserialize(JsonNode node) {
