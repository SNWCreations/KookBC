...
/**
 * RoleInfoUpdateEvent 的 Jackson 反序列化器
 *
 * @since KookBC 0.33.0
 */
public class RoleInfoUpdateEventJacksonDeserializer extends BaseJacksonEventDeserializer<RoleInfoUpdateEvent> {

    public RoleInfoUpdateEventJacksonDeserializer(KBCClient client) {
        super(client);
    }

    @Override
    protected RoleInfoUpdateEvent deserialize(JsonNode node) {
