...
/**
 * GuildInfoUpdateEvent 的 Jackson 反序列化器
 *
 * @since KookBC 0.32.2
 */
public class GuildInfoUpdateEventJacksonDeserializer extends BaseJacksonEventDeserializer<GuildInfoUpdateEvent> {

    public GuildInfoUpdateEventJacksonDeserializer(KBCClient client) {
        super(client);
    }

    @Override
    protected GuildInfoUpdateEvent deserialize(JsonNode node) {
